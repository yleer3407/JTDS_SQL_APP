...
public class MyAdapter2 extends BaseAdapter {
    ...
    public MyAdapter2(ArrayList<EnviromentQrder> list_data, Context context){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if(convertView==null){
            viewHold=new MyAdapter2.ViewHoled();
            convertView= View.inflate(context,R.layout.adapt_item,null);
            ...
            viewHold=(MyAdapter2.ViewHoled) convertView.getTag();
        }
